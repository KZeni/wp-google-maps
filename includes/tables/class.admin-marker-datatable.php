...
class AdminMarkerDataTable extends MarkerDataTable
{
	...
	protected function getActionButtons()
	{
		...
		return 'REPLACE(\'
			...
			<a href="?page=wp-google-maps-menu&amp;action=edit_marker&amp;id=' . $id_placeholder . '" title="Edit this marker location" class="wpgmza_edit_btn button" id="' . $id_placeholder . '">
				<i class="fa fa-map-marker"> </i>
			</a>
			<a href="javascript:void(0);" title="Delete this marker" class="wpgmza_del_btn button" id="' . $id_placeholder . '">
